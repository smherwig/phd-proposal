...
%
I ask whether it is possible to run legacy application binaries
with confidentiality and integrity guarantees that reflect a multi-party
trust setting.
%
...
allow an application to dynamically switch execution to different
domains---hosts and enclaves---, and pin to data to domains, via
language-neutral mechanisms.
