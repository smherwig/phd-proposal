...
domains (such as a host) that they trust; a thread's exeuction migrates to the
...
may install in a trusted environment that enforce expected behavior of
untrusted application.
%
A key feature of policy monitors is that the policies express a specification
for program correctness that the monitor dyanmically enforces with fine-grain
