...
%
We ask whether codomains compose with pthreads to achieve a distributed,
parallel programming model similar to MPI.  \footnote{A related question is
whether codomains can augment MPI; we leave this as interesting future work.
}
...
We sketch a design for how this might work in Listing~\ref{lst:lwc-parallel}.
%
