...
\parhead{Example firewall policies}
...
\parhead{Application: HTTPS Server}
%
...
%
%   Maybe this motivates having "classes" of tags.  For instance, some tags
%   specify a provenance (this data was processed by such and such); others
%   specify an access control (such and such code may read/write this data).
%
%   Is there ever a case where a monitor would want to dynamically create a
%   tag?
%       This gets into the question of how taint gets introduced, or is it
%       merely external to the system.  For instance,in the provenance case,
%       the origin server needs to tag the content that it sends to the edge
%       server, and such content may be dynamic.  
%
