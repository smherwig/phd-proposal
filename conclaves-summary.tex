...
At a high level, my approach is to deploy applications in enclaves.
%
...
%
Conversely, I aim to be able to support dynamic scaling up and down of
web servers, tenant configurations, and security postures.

To address these challenges, I introduce a new architectural primitive that we
call a \emph{conclave}: in essence a container of enclaves.
%
As I will show, conclaves permit flexible deployment configurations and
